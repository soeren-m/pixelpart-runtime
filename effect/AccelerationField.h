...
public:
	...
	void accelerationGrid(std::int32_t x, std::int32_t y, std::int32_t z);
	void accelerationGrid(std::int32_t x, std::int32_t y, std::int32_t z,
	...
	std::int32_t accelerationGridSizeX() const;
	std::int32_t accelerationGridSizeY() const;
	std::int32_t accelerationGridSizeZ() const;
...
private:
	...
	std::int32_t fieldAccelerationGridSize[3] = { 1, 1, 1 };
